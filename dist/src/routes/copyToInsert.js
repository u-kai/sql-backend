...
router.post("/", function (req, res) {
    ...
    var columns = Object.keys(sendData.multiLineCells[0]);
    var values = "";
    var initSql = "INSERT INTO " + sendData.tableName + " (" + columns.join(",") + ")";
    var sql = initSql;
    var sqls = [];
    var errorList = [];
    var resultList = [];
    sendData.multiLineCells.map(function (columnValue) {
        ...
        console.log(sql);
        sqls = __spreadArray(__spreadArray([], sqls), [sql]);
        values = "";
    });
    (function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, _b, _i, sqlIndex, connection, e_1;
